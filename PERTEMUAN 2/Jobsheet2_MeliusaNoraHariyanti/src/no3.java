    ...
    public static void main(String[] args) {
        ...
        try {
            while (running) {
                ...
                System.out.println("--------------------------------- -");
                System.out.println("o> Total bayar\t: " + b.hitungHargaBayar(b.hitungHargaTotal(b.harga_satuan, b.jumlah), b.hitungDiskon(b.hitungHargaTotal(b.harga_satuan, b.jumlah))));
